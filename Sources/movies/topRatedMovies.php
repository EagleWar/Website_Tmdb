<?php
	...
	$movies = $tmdb->getTopRatedMovies($page, $_GET['language']);
	...
	echo '          </ul>
		            </div> <a href="index.php?zone=movies&item=topRatedMovies&page=' . $page . '&language=' . $_GET['language'] . '"style="margin-left:85%"
