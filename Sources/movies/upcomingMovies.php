<?php
	...
	$movies = $tmdb->getDiscoverMovies2($page,'2018',null,null,null, $_GET['language']);
	...
	echo '          </ul>
		            </div> <a href="index.php?zone=movies&item=upcomingMovies&page=' . $page . '&language=' . $_GET['language'] . '"style="margin-left:85%"
