<?php
	...
	$movies = $tmdb->getNowPlayingMovies($page, $_GET['language']);
	...
	echo '          </ul>
		            </div> <a href="index.php?zone=movies&item=nowPlayingMovie&page=' . $page . '&language=' . $_GET['language'] . '"style="margin-left:85%"
