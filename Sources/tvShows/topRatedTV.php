<?php
	...
	$movies = $tmdb->getTopRatedTVShows($page, $_GET['language']);
	...
	echo '          </ul>
		            </div> <a href="index.php?zone=tvShows&item=topRatedTV&page=' . $page . '&language=' . $_GET['language'] . '"style="margin-left:85%"
